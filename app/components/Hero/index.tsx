    ...
    return (
        <div className="flex justify-center items-center">
            <div className="flex flex-col justify-center items-start gap-7 w-1/2">
                ...
                <a href="https://calendly.com/grupocintec/30min?back=1&month=2024-02" className="rounded-full bg-secondary hover:bg-light transition duration-300 text-white py-3 px-6 text-xl">
